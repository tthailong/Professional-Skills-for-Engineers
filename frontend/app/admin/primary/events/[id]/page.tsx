   ...
   if (!event)
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
        <div className="p-6 bg-primary/10 rounded-[2.5rem] mb-6">
  ...
  return (
     <div className="min-h-screen bg-background relative overflow-hidden text-foreground selection:bg-primary/20 transition-colors duration-500">
      ...
      <div className="absolute top-0 left-0 w-full h-[70vh] -z-10 opacity-30 blur-[120px]">
        <div className="absolute top-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-primary/20" />
        <div className="absolute bottom-0 left-[10%] w-[40%] h-[40%] rounded-full bg-accent/10" />
      </div>
      ...
      <main className="container mx-auto px-4 pt-12 pb-24 relative z-10 max-w-6xl">
        {/* Navigation */}
         <motion.button
          ...
          onClick={() => router.back()}
          className="group flex items-center gap-2 text-muted-foreground hover:text-primary font-bold text-sm uppercase tracking-widest transition-all mb-12"
        >
          <div className="p-2 rounded-xl bg-muted group-hover:bg-primary group-hover:text-white transition-all shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          >
             <div className="relative group">
              <div className="aspect-[2/3] rounded-[3.5rem] overflow-hidden shadow-2xl shadow-primary/10 border-[12px] border-card group-hover:scale-[1.02] transition-transform duration-700">
                <img
                  src={event.poster}
                  alt={event.title}
              ...
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-primary rounded-[2rem] flex items-center justify-center shadow-xl shadow-primary/40">
          ...
          >
            <div className="space-y-4">
               <div className="flex items-center gap-3">
                <span className="px-4 py-1.5 bg-primary text-white rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-lg shadow-primary/20">
                  {event.type}
                </span>
                <span
             ...
             <Card className="border-none bg-card/60 backdrop-blur-2xl shadow-xl rounded-[3rem] p-10 border border-border/50">
              <CardContent className="p-0 space-y-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                  ...
                  <div className="flex items-start gap-5">
                    <div className="p-4 bg-muted rounded-2xl text-muted-foreground shadow-inner border border-border/50">
                 ...
                 <div className="pt-10 border-t border-border/50">
                  <p className="text-[10px] font-black uppercase text-primary tracking-widest mb-6 flex items-center gap-2">
                ...
                <div className="pt-6 flex flex-col sm:flex-row gap-4">
                  <Button className="flex-1 h-16 rounded-2xl bg-primary hover:bg-primary/90 text-white font-black text-lg shadow-xl shadow-primary/20 transition-all active:scale-95">
                    Promote This Event
                  </Button>
                  <Button
                    variant="outline"
